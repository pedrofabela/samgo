                                                ...
                                                <s:form name="formularioPrincipal" id="formularioPrincipal">
                                                    ...
                                                    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="sideNav" style="background: #072146; " >
                                                        ...
                                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                            <ul class="navbar-nav">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link js-scroll-trigger" href="" data-toggle="modal" data-target="#logoutModal">Cerrar Sesion</a>
                                                                </li>
                                                    ...
                                                    <div class="container-fluid p-0">
                                                        ...
                                                        <div style="margin-top: 40px;"> 
                                                            ...
                                                            <table style="width: 80%; margin: auto; margin-top: 20px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 25%;"><s:textfield cssClass="form-control" name="datos.FECHA_DOC" id="Fecha" onchange="javascript:Accion('actualizaFecha')"></s:textfield></td>
                                                                    </tr>
                                                                ...
                                                                <div class="mb-1" style="width: 100%; height: 40px; color:#072146; margin-bottom: 30px; font-size: 24px; margin: auto; text-align: center; margin-top: 30px;"><h3 class="mb-0" style="color: #95a0b0;"> Objetivo </h3>  </div>
                                                        ...
                                                        <table style="width:80%; margin: auto; margin-top: 30px;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <s:textfield name="datos.RES_RE" id="RES_RE" cssClass="form-control" placeholder="Nombre de quien revisa"></s:textfield>
                                                                    </td>

                                                                    <td>
                                                                    <s:textfield name="datos.RES_AUT" id="RES_AUT" cssClass="form-control" placeholder="Nombre de quien autoriza"></s:textfield>
                                                                    </td>
                                                        ...
                                                        <div class="  col-lg-12 text-center" >
                                                            <s:url action="GeneraPdf" id="myUrl" escapeAmp="false">
                                                                ...
                                                                <s:param name="TipoReporte" value="'SAMGO.jasper'"/>
                                                                <s:param name="cve_unidad" value="datos.CVE_UNIDAD"/>
                                                                <s:param name="esExcel" value="'false'"/>
                                                                <s:param name="esPDF" value="'true'"/>            

                                                            </s:url> 

                                                            <a  href= "<s:property value="#myUrl"/>" target="_blank" ><i class="fa fa-file-pdf " style="font-size: 80px; color: #28a745"></i><span style="color: #28a745"> Descarga de archivo </span></a>                                                        
